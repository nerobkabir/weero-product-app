...
const InputField = ({ icon: Icon, label, name, type, placeholder, autoComplete, rightEl, value, onChange, error }) => (
  <div>
    ...
    <div className="relative">
      ...
      <input
        ...
        className={`w-full pl-10 ${rightEl ? 'pr-11' : 'pr-4'} py-3 rounded-xl border text-sm bg-slate-50 dark:bg-[#1a1a1a] text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 outline-none transition-all
          ${error
      ...
      <div className="flex items-center justify-center p-8 lg:p-16 order-2 lg:order-1">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Sign Up</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 px-6 rounded-xl bg-violet-600 hover:bg-violet-700 text-white font-semibold text-sm transition-all shadow-lg shadow-violet-500/25 disabled:opacity-60 disabled:cursor-not-allowed mt-2"
            >
              {loading ? (
                <>
      ...
      <div className="hidden lg:flex bg-slate-50 dark:bg-[#111] border-l border-slate-100 dark:border-[#1e1e1e] items-center justify-center p-12 relative overflow-hidden order-1 lg:order-2">
        ...
        <div className="relative w-full max-w-sm">
          <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-slate-200 dark:border-[#2a2a2a] shadow-xl p-6 mb-4">
            <p className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-4">What you get</p>
